...
├──  logo.jpg                             # Imagen del logo principal usado en la interfaz de usuario.
├──  serviciudad_pdf_header.png           # Imagen de la cabecera para los reportes PDF.
└──  serviciudad_pdf_footer.jpg           # Imagen del pie de página para los reportes PDF.
```
